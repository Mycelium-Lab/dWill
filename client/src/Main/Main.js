    ...
    render() {
        return(
            <div className='main-text'>
                ...
                <p className="block-three">Благодаря технологии смарт-контрактов Will работает полностью децентрализованно,
...
не будет доступа к средствам, которые вы завещали. <a href='#'className=''>Подробнее о том, как это работает.</a></p>
                <p className="block-four"> Чтобы создать свое первое завещание или управлять созданными подключите свой кошелек Ethereum</p>
                {
